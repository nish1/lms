...
<div id="cssmenu">
<ul>
<li><a href="membership.jsp">Back</a></li>
...
try {
	...
	stmt.executeUpdate("Insert into membership values("+memid+")");
   ...
   stmt = null;
		try {
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/lms", "root", "password");
			stmt=con.createStatement();
			stmt.executeUpdate("Insert into member values('" +name+"',"+memid+",'"+department+"',"+semester+")");
			%>
			<center><font size="6px">
			<% out.println("Membership created Successfully");%>
