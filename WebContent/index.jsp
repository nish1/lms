...
<ul>
  ...
  <li><a href="#" onclick="show();">Login</a>
  </ul></div>
  <br><br><br>
	...
	<center>
	<font size="20px" color="black">Library Management System</font>
	</center>
		<br><br><br><br><br>
        <div id="logon" style="display: none;">
		<form action="login" method="post">
		<center>
			<table bgcolor="#81BEF7" cellpadding="8" >
			<tr ><td colspan="10" align="center"><h2><font color="black">Login Here</font></h2></td><td></td></tr>
				<tr>
