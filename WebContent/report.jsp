...
<br><br><br>
<center>
<form action="reportavailability.jsp" method="post">
<table><tr>
<td><font size="5px">Search criteria</font></td><td><br>&nbsp;<select name="repcriteria" style="width:145px;"> 
<option value="repsemester">Semester</option>
<option value="sname">Student Name</option>

</select><br><br></td></tr>
<tr><td><font size="5px">Semester</font></td>
<td><br>&nbsp;<select name="sem" style="width:145px;">
                       ...
                       <option value="2">2</option>
                		...
                		Statement stmt = null;
                		ResultSet rs = null;
                   		query1="select name from member";
                	    try {
                		...
                		%><tr><td><br><font size="5px">
                		 Student Name</font></td><td><br>&nbsp;<select name="Sname" style="width:145px;">
...
<br><br><br>
<input type="submit" value="reportavailability"/>
</form>
</center>
</body>
</html>