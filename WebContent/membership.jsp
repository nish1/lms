...
<center>
	<font size="6" color="BF2D34" face="britannic bold">STUDENT MEMBERSHIP FORM</font>
	</center><br>
<table bgcolor="grey" cellpadding="11" >
				<tr>
				...
				<tr>
					<td><font size="5" color="yellow" face="britannic bold">Department</font></td>
				...
				<tr><td><font size="5" color="yellow" face="britannic bold">Semester</font></td>
					<td><select name="sem" style="width:145px;">
                       <option value="">select</option>
