...
<tr><td>ISBN</td><td>BOOKNAME</td><td>SEMESTER</td><td>STREAM</td><td>AUTHOR</td><td>TOTAL</td><td>AVAILABLE</td><td>STATUS</td></tr>
<%
		int flag=0;
		String query=null;
		String stream=null;
	    ...
	    switch(flag){
		case 1:
			query="select * from books,book_availability where books.isbn=book_availability.isbn and semester="+ sem +"";
			break;
		case 2:
			query="select * from books,book_availability where books.isbn=book_availability.isbn and stream='"+stream+"'";
			break;
		case 3:
			query="select * from books,book_availability where books.isbn=book_availability.isbn and semester="+sem+" and stream='"+stream+"'";	
		break;
	    	}
